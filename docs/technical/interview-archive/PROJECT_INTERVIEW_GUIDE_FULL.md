...
> 归档说明：本文是整理前的完整长版手册，保留用于追溯历史内容和细节证据。当前面试复习请优先使用 `docs/interview/` 下的 P0/P1/P2 分级背诵材料；如果本文与当前代码或最新背诵材料冲突，以 `docs/README.md`、`docs/API.md`、`docs/interview/` 和最新 progress/tests 为准。
...
```text
docs/technical/motion/MOTION_MEDIA_PIPELINE_DESIGN.md
```
...
- Multi-intent routing 已完成 Phase 4，详见 `docs/technical/router/MULTI_INTENT_ROUTING_DESIGN.md`；当前只对白名单中的两步组合执行多子图，其他组合仍降级为 `primary_intent` 单路由。
