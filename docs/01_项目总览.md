...
本文档是项目当前状态的事实入口：回答项目做什么、已经做到哪里、当前边界和下一步。面试学习请先看 [00_先看这里.md](./00_先看这里.md)，运行命令集中在 [03_运行排错.md](./03_运行排错.md)，接口细节集中在 [02_接口说明.md](./02_接口说明.md)。

## 先看哪份

如果你只是为了面试复习，不需要从本文档从头读到尾，直接按这个顺序：

1. [00_先看这里.md](./00_先看这里.md)：最短学习路线。
2. [interview/04_ONE_PAGE_CHEAT_SHEET.md](./interview/04_ONE_PAGE_CHEAT_SHEET.md)：面试前速记。
3. [interview/01_MUST_MASTER_PROJECT_STORY.md](./interview/01_MUST_MASTER_PROJECT_STORY.md)：项目主线。
4. [interview/02_SHOULD_MASTER_TECH_QA.md](./interview/02_SHOULD_MASTER_TECH_QA.md)：技术追问。
