...
| 日期 | 记录 | 重点 |
|---|---|---|
| 2026-07-01 | [Milvus RAG 后端实现](./2026-07-01-milvus-rag-backend.md) | Memory/Milvus 双 Retriever 后端、配置切换、fallback 和测试 |
| 2026-07-01 | [Milvus RAG 接入（WIP）](./2026-07-01-milvus-rag-wip.md) | 远端 WIP 阶段记录，已由后续实现记录接续 |
