...
> 归档说明：这是项目启动阶段的任务拆解，复选框不再代表当前完成度。当前状态统一查看 [../../项目总览.md](../../项目总览.md)。
...
### 任务 2: LLM 加载器 — Qwen3 Transformers 封装
...
### 任务 9: Motion 子图 — 3D 动作分析 (ReAct 推理链)
