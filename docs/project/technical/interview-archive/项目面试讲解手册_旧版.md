...
> 归档说明：本文是整理前的完整长版手册，保留用于追溯历史内容。当前面试复习请优先使用 `docs/learning/`；如果本文与当前代码或新材料冲突，以 `docs/project/项目总览.md`、`docs/project/接口说明.md`、`docs/project/项目证据.md` 和当前 `docs/learning/` 为准。
...
- Multi-intent routing 已完成 Phase 4，详见 `docs/project/technical/router/多意图路由设计.md`；当前只对白名单中的两步组合执行多子图，其他组合仍降级为 `primary_intent` 单路由。
