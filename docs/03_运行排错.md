...
本文档集中维护本地开发、测试、评测、Docker 和端侧联调命令。项目能力和当前进度看 [01_项目总览.md](./01_项目总览.md)，接口参数看 [02_接口说明.md](./02_接口说明.md)。
...
更完整的请求示例和上传接口说明见 [02_接口说明.md](./02_接口说明.md)。
...
当前绿色回归集为 66 条、100% accuracy；challenge set 为 36 条，primary intent、secondary intent 和 route plan exact match 均为 36/36。关键结果和边界以 [04_项目证据.md](./04_项目证据.md) 为入口。
